...
const accountSlice = createSlice({
  ...
  reducers: {
    ...
    // Dispatched Action paramter ({ loanAmount, loanPurpose })
    // requestLoan: function (state, action) {
...
// Use the legacy way to create action thunk in combine with new redux-toolkit method
// **********************************************************************************
