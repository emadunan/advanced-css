...
export type Chat = {
  ...
  userIds: Array<Scalars['Float']['output']>;
};
...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', id: number, userId: number, isPrivate: boolean, userIds: Array<number>, name: string } };
